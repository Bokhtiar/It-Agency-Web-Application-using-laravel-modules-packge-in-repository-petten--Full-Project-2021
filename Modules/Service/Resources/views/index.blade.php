                                        ...
                                        <td>
                                            @if ($service->status == 0)
                                                <a class="btn btn-sm badge badge-pill btn-success"
                                                    href="{{ url('service/status/' . $service->id) }}">Active</a>
                                            @else
                                                <a class="btn btn-sm badge badge-pill btn-danger"
                                                    href="{{ url('service/status/' . $service->id) }}">Inactive</a>
                                            @endif

                                            <a class="btn btn-sm btn-success"
                                                href="{{ url('service/edit/' . $service->id) }}"><i
                                                    class="fas fa-user-edit"></i></a>


                                            <a class="btn btn-sm btn-danger"
                                                href="{{ url('service/delete/' . $service->id) }}"><i
