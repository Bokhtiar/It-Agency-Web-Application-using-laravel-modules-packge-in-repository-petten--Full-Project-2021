    ...
    <section class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <!-- Card body -->
                <div class="card-body">
                    <form action="{{url('expenses/store/'.$expense->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="form-control-label">Expenses Amount</label>
                            <input class="form-control" type="number" name="amonut" value="{{$expense->amonut}}" placeholder="Expenses amount" required>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" for="exampleFormControlTextarea1">Expenses Description</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="3" required>{{$expense->description}}</textarea>
                        </>
                          <div class=" p-3 mb-4">
