        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-item-center">
                    <h2 class="mb-0">Slider Update Form</h2>
                ...
                <!-- Card body -->
                <div class="card-body">
                    <form action="{{url('slider/store/'.$slider->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="form-control-label">Slider Name</label>
                            <input class="form-control" type="text" name="name" value="{{$slider->name}}" placeholder="Slider Name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="3" required>{{$slider->description}}</textarea>
                        </div>
                          <div class=" p-3 mb-4">
