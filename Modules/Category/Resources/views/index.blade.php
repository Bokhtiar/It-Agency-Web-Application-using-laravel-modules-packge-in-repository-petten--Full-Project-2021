                                ...
                                <table class="table table-flush" id="datatable-basic">
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($category->status == 0)
                                                        <a class="btn btn-sm badge badge-pill btn-success"
                                                            href="{{ url('category/status/' . $category->id) }}">Active</a>
                                                    @else
                                                        <a class="btn btn-sm badge badge-pill btn-danger"
                                                            href="{{ url('category/status/' . $category->id) }}">Inactive</a>
                                                    @endif
                                                    @isset(auth()->user()->role->permission['permission']['category']['edit'])
                                                        <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                                            data-target="#modal-form{{ $category->id }}"><i
                                                                class="fas fa-user-edit"></i></button>
                                                    @endisset
                                                    @isset(auth()->user()->role->permission['permission']['category']['delete'])
                                                        <a class="btn btn-sm btn-danger"
                                                            href="{{ url('category/delete/' . $category->id) }}"><i
                                            ...
                                            <div class="col-md-4">
                                                <div class="modal fade" id="modal-form{{ $category->id }}" tabindex="-1"
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-header ">
                                                                            ...
                                                                            <a class="text-light btn btn-icon btn-primary"
                                                                                ...
                                                                                <span class="btn-inner--text">category
                                                                                    List</span>
                                                                            </a>
                                                                        </div>
                                                                        <!-- Card body -->
                                                                        <div class="card-body">
                                                                            <form
                                                                                action="{{ url('category/store/' . $category->id) }}"
