    ...
    <section class="row">
        <div class="col-md-6 col-lg-6 col-sm-12">
            <section class="row justify-content-center">
                <div class="col-md-10">
                    <form action="{{url('blog/store/'.$blog->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="card">
                        <!-- Card header -->
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{$blog->title}}" name="title" placeholder="blog Title" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="exampleFormControlTextarea1"> Short blog Description</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="short_des" rows="3" required>{{$blog->short_des}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="exampleFormControlTextarea1">blog Description</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="body" rows="3" required>{{$blog->body}}</textarea>
                                </div>
                        </div>
                      </div>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            @endphp
                                            <p>
                                                <img src="{{asset($image[0])}}" height="80px" width="80px" alt="">
                                            </p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @php
                                            $images = json_decode($blog->cover_image);
                                            @endphp
                                            <p>
                                                @foreach ($images as $image)

                                                @endforeach
                                                <img src="{{asset($image)}}" height="80px" width="80px" alt="">
                                            </p>
                                        </div>
                                </div>
                              </div>
