              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        $image=json_decode($quote->image);
                        @endphp
                        <img src="{{asset($image[0])}}" height="60px" width="60px" alt=""> </td>
                    <td>
                        @if ($quote->status ==1)
                    ...
                    <td>
                        @if ($quote->status ==0)
                        <a class="btn btn-sm badge badge-pill btn-success" href="{{url('quote/status/'.$quote->id)}}">Active</a>
                        @else
                        <a class="btn btn-sm badge badge-pill btn-danger" href="{{url('quote/status/'.$quote->id)}}">Inactive</a>
                        @endif
                        @isset(auth()->user()->role->permission['permission']['quote']['delete'])
                        <a class="btn btn-sm btn-danger" href="{{url('quote/delete/'.$quote->id)}}"><i class="fas fa-trash"></i></a>
                        @endisset
                    </td>
                  </tr>
                  @endforeach
