...
{{--
<a href="{{url('role')}}">Role</a><br>
<a href={{url('permission')}}>Permission</a><br>
<a href="{{url('admin/settings')}}">Settings</a> <br>
<a href="{{url('navbar/create')}}">navbar & Footer Page create</a> <br>
<a href="{{url('social/')}}">Social Info</a> --}}
